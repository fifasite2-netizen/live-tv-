    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="flex items-center gap-3 rounded-xl bg-zinc-900/40 p-4 border border-zinc-800/60">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-white">{nextMatch}</p>
        </div>
      </div>
      <div className="flex items-center gap-3 rounded-xl bg-zinc-900/40 p-4 border border-zinc-800/60">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-white">{liveScore}</p>
        </div>
      </div>
      <div className="flex items-center gap-3 rounded-xl bg-zinc-900/40 p-4 border border-zinc-800/60">
        ...
        <div>
          ...
          <p className="text-sm font-bold text-white">{possession}</p>
        </div>
      </div>
    </div>
  );
