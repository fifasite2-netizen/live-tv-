...
const Navbar = () => {
  return (
    <header className="sticky top-0 z-50 max-w-7xl mx-auto border-b border-neutral-800 bg-neutral-900/80 backdrop-blur-md px-6 py-4 flex items-center justify-between text-white">
